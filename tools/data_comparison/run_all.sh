...
bash cmds.sh
cd ../../../..
cd tools/data_comparison/train-records/minisat_randomk3/data_train
bash cmds.sh
cd ../../../..
cd tools/data_comparison/train-records/minisat_randomk3/data_traintest
bash cmds.sh
cd ../../../..
cd tools/data_comparison/train-records/minisat_randomk3/data_val
bash cmds.sh
cd ../../../..
